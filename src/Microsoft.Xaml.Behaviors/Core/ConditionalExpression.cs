...
namespace Microsoft.Xaml.Behaviors.Core
{
    ...
    public class ConditionalExpression :
        ...
        ICondition
    {
        public static readonly DependencyProperty ConditionsProperty = DependencyProperty.Register(nameof(Conditions),
            typeof(ConditionCollection), typeof(ConditionalExpression), new PropertyMetadata(null));

        public static readonly DependencyProperty ForwardChainingProperty =
            DependencyProperty.Register(nameof(ForwardChaining), typeof(ForwardChaining), typeof(ConditionalExpression),
        ...
        {
            this.SetValue(ConditionsProperty, new ConditionCollection());
        }
        ...
        public bool Evaluate()
        {
            ...
            foreach (ComparisonCondition operation in this.Conditions)
            {
                ...
                switch (result)
                {
                    case false when this.ForwardChaining == ForwardChaining.And:
                        return false;
                    case true when this.ForwardChaining == ForwardChaining.Or:
                        return true;
                }
            }
