    ...
    public class MouseDragElementBehavior : Behavior<FrameworkElement>
    {
        ...
        protected override void OnAttached()
        {
            this.AssociatedObject.AddHandler(UIElement.MouseLeftButtonDownEvent,
                new MouseButtonEventHandler(this.OnMouseLeftButtonDown), false /* handledEventsToo */);
        }
        ...
        protected override void OnDetaching()
        {
            this.AssociatedObject.RemoveHandler(UIElement.MouseLeftButtonDownEvent,
                new MouseButtonEventHandler(this.OnMouseLeftButtonDown));
        }
        ...
        private Transform RenderTransform
        {
            get
            {
                ...
                Transform clonedTransform = CloneTransform(this.AssociatedObject.RenderTransform);
        ...
        internal void ApplyTranslationTransform(double x, double y)
        {
            ...
            if (translateTransform == null)
            {
                ...
                {
                    case TransformGroup renderTransformGroup:
                    {
                        if (renderTransformGroup.Children.Count > 0)
                        {
                            translateTransform =
                                renderTransformGroup.Children[renderTransformGroup.Children.Count - 1] as
                                    TranslateTransform;
                        }
                    ...
                    case MatrixTransform renderMatrixTransform:
                    {
        ...
        internal static Transform CloneTransform(Transform transform)
        {
            ...
            {
                return new TranslateTransform { X = translateTransform.X, Y = translateTransform.Y, };
            }

            if ((matrixTransform = transform as MatrixTransform) != null)
            {
                return new MatrixTransform { Matrix = matrixTransform.Matrix, };
            }
        ...
        internal void StartDrag(Point positionInElementCoordinates)
        {
            ...
            this.AssociatedObject.AddHandler(UIElement.MouseLeftButtonUpEvent,
                new MouseButtonEventHandler(this.OnMouseLeftButtonUp), false /* handledEventsToo */);
        }
        ...
        internal void EndDrag()
        {
            this.AssociatedObject.MouseMove -= this.OnMouseMove;
            this.AssociatedObject.LostMouseCapture -= this.OnLostMouseCapture;
            this.AssociatedObject.RemoveHandler(UIElement.MouseLeftButtonUpEvent,
                new MouseButtonEventHandler(this.OnMouseLeftButtonUp));
        }
