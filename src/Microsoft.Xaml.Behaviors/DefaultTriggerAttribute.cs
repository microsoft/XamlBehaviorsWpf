...
namespace Microsoft.Xaml.Behaviors
{
    ...
    [SuppressMessage("Microsoft.Design", "CA1019:DefineAccessorsForAttributeArguments",
        Justification = "FxCop is complaining about our single parameter override")]
    public sealed class DefaultTriggerAttribute : Attribute
    {
        ...
        public DefaultTriggerAttribute(Type targetType, Type triggerType, object parameter) :
            this(targetType, triggerType, new[] { parameter })
        {
        }
        ...
        public TriggerBase Instantiate()
        {
            try
            {
                return (TriggerBase)Activator.CreateInstance(this.TriggerType, this.parameters);
            } catch
            {
                return null;
            }
